                    ...
                    <form method="post" enctype="multipart/form-data" name="account_setting">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if (move_uploaded_file($_FILES['ph']['tmp_name'], $target_path) && $pass == $conf_password) {
                                ...
                                $res = mysql_query("update `residentregistration` SET username='$uname',password='$pass',photo='$pho', where account_id='$id'");
                                if ($res > 0) {
                        ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" value="Profile Picture" name="ph"><br />
                            <div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <a href="C_pofile_setting.php" class="btn btn-primary">Back</a>
                        </div>
                    </form>
                </div>
            </div>
